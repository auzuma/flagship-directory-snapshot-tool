...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 flex flex-col h-screen">
  ...
  <div class="flex flex-1 overflow-hidden">
    <!-- Sidebar -->
    <div id="sidebar" class="w-64 bg-white dark:bg-gray-800 shadow-md flex flex-col">
        ...
        <div class="mb-4">
          <div class="flex items-center justify-between mb-2">
            ...
            <div>
              ...
              <button id="clear-selections-btn" class="text-sm text-blue-500 hover:text-blue-600">🗑️ Clear</button>
            </div>
          </div>
...
---FILEEND---</pre>
  ...
  <!-- Footer -->
  <footer class="bg-white dark:bg-gray-800 shadow-md p-3 text-center text-sm text-gray-600 dark:text-gray-400">
    &copy; 2025 Py_markdown-directory-snapshot-special
  </footer>
...
---FILESTART: package-lock.json---
{
  "name": "directory-snapshot-tool",
  "version": "1.0.0",
  "lockfileVersion": 3,
  "requires": true,
  "packages": {
...
---FILESTART: package.json---
{
  "name": "directory-snapshot-tool",
  "version": "1.0.0",
  "description": "Desktop application for creating and recreating directory snapshots",
  "main": "main.js",
  "scripts": {
    "start": "electron .",
  ...
  "build": {
    "appId": "com.directory-snapshot-tool",
    "productName": "Directory Snapshot Tool",
    "win": {
      "target": "nsis",
...
---FILESTART: styles\custom.css---
/* Custom CSS for Directory Snapshot Tool */
...
.dark #sidebar-resize-handle:hover {
  background-color: #2563eb;
}
...
---FILESTART: token-counter-simple.js---
